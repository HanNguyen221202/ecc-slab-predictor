...
if run_button:
    with st.spinner("Analyzing data..."):
        ...
        with col_res1:
            MAE_error = 4.80
            st.markdown("<p style='font-size: 22px; margin-bottom: 0px; color: #FAFAFA;'>Predicted Punching Shear Capacity of ECC-Strengthened Flat Slabs (Vp)</p>", unsafe_allow_html=True)
            st.markdown(
